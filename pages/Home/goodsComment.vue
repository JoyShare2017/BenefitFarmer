			...
			<view class="uni-list">
				<view class="uni-list-cell" style="display: flex;flex-direction: column;background-color: #F4F5F6;">
					...
					<view class="cell_holder" v-for="(noti, index) in showNewsData" :key="index" @click="seeDetail(noti)">
						...
						<view class="uni-row">
							<!-- 左头像 -->
							<view style="width: 150rpx;height: 120rpx;margin-top: 20rpx;margin-bottom: 20rpx;">
						...
						<view class="cell_title">质量一级棒，强烈推荐，好评！！！</view>
						
						<!-- 晒图 -->
						<view class="imgsHolder">
							<image class="img" v-for="(item,index) in 'kisssss'" src="" mode="">
						...
						<!-- 时间评论点赞 -->
						<view class="uni-row">
							<view class="cell_time" style="width: 70%;">2020-6-27</view>
							<view class="cell_time" style="width: auto;">
								评论
							</view>
							<view class="cell_time" style="width: auto;">
								点赞
						...
						<!-- 评论回复 -->
						<view class="uni-row" style="background-color: #E5E5E5;padding: 20rpx;">
							<!-- 左头像 -->
							<view style="width: 150rpx;height: 120rpx;margin-top: 20rpx;margin-bottom: 20rpx;">
								<image class="cell_icon" src="" mode="">
							...
							<view class="uni-column" style="width: calc(100% - 150rpx);margin-top: 30rpx;">
								<view >
									<view class="cell_title">花前***  会员号：31559826"</view>
									<view class="cell_title">回复 北极***：质量怎么样</view>
									<view class="uni-row">
										<view class="cell_title" style="width: 70%;">
											2020-06-28- 12:30:5
										</view>
										<view class="cell_time" style="width: auto;">
											点赞
